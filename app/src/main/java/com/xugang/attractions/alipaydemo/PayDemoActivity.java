...
public class PayDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExternalFragment externalFragment = new ExternalFragment(name, price, summary);
        fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.fl, externalFragment);
        fragmentTransaction.show(externalFragment);
    ...
    public void pay(View v) {
        ...
        String orderInfo = getOrderInfo(name, summary, price);
