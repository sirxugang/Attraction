 ...
 */
public class VpFragmentTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        drawable.start();
        tvday.setText("明天白天");
        tvnight.setText("明天夜间");
        return view;
    }

    @Subscribe(threadMode = ThreadMode.MAIN, priority = 80, sticky = true)
    public void setInfo(WeatherBean.ShowapiResBodyBean.F2Bean ftwo) {
        Log.e(TAG, "setInfo: ");
        sdvDay.setImageURI(Uri.parse(ftwo.getDay_weather_pic()));
        tvTianQi.setText(ftwo.getDay_weather());
        tvWenDu.setText(ftwo.getDay_air_temperature() + "°");
        tvFengxiang.setText(ftwo.getDay_wind_direction());
        tvFengLi.setText(ftwo.getDay_wind_power());
        tvZiWaiXian.setText(ftwo.getZiwaixian());
        tvJiangShui.setText(ftwo.getJiangshui());

        sdvNight.setImageURI(Uri.parse(ftwo.getNight_weather_pic()));
        tvTianQiII.setText(ftwo.getNight_weather());
        tvWenDuII.setText(ftwo.getNight_air_temperature() + "°");
        tvFengxiangII.setText(ftwo.getNight_wind_direction());
        tvFengLiII.setText(ftwo.getNight_wind_power());

        tvRiChuRiLuo.setText(ftwo.getSun_begin_end());
    }
